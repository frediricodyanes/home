...
async function fetchData(){
  try {
    const UNSPLASH_API_KEY = "TccZKDXp9rzfJUM7avYkdoikF-6NFDgdYhvZF5HiunQ"; // Remplacez par votre clé API Unsplash si celle-ci expire
    const response = await fetch(`https://api.unsplash.com/search/photos?page=${pageIndex}&per_page=30&query=${searchQuery}&client_id=${UNSPLASH_API_KEY}`)
